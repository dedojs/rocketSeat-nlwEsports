    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        <Dialog.Overlay className='bg-black/60 inset-0 fixed'>
          <Dialog.Content className='fixed bg-[#2A2634] py-8 px-4 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[600px] shadow-lg shadow-black/25'>
            ...
            <form onSubmit={ handleForm } className='mt-8 flex flex-col gap-4'>
              ...
              <div className='grid grid-cols-2 gap-6'>
                <div className='flex flex-col gap-2'>
                  ...
                  <Input name='years' id='years' type="number" placeholder='Tudo bem ser zero :)' />
                </div>
              ...
              <label className='mt-2 flex items-center gap-2 text-sm'>
                <Checkbox.Root
                  ...
                  if (checked === true) setUseVoice(true)
                  else setUseVoice(false)
                  } 
                }
                >
                  <Checkbox.Indicator>
